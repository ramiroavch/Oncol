...
@section('title')
<form class="form-group" method="POST" action="/HistoriaNo/{{$historia->num_h}}">
    @method('PUT')
    @csrf
        ...
        <div class="col-lg-4 col-sm-3">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control input-sm" name=tlf" placeholder="Telefono" value="{{$paciente->tlf}}">
                    </div>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" style="resize:none;" rows="2" name="antecotros">{{$paciente->antec_otros}}</textarea>
                    </div>
                </div>
            </div>
            <div class="ibox float-e-margins">
